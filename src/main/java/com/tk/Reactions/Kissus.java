...
public class Kissus {
    public static void kiss( MessageChannel channel, String dedicate, int number, String authorName ){
        ...
        com.tk.Reactions.Reacting.sendMessage(com.tk.Reactions.Reacting.mountMessage("Kissed", dedicate, authorName, number), com.tk.Reactions.Reacting.animateFile(number, caminho), channel);
    }
